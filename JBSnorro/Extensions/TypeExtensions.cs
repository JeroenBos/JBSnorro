...
namespace JBSnorro.Extensions
{
    ...
    public static class TypeExtensions
    {
        ...
        /// <summary>
        /// Gets whether the specified object overrides <see cref="object.ToString"/>.
        /// </summary>
        public static bool OverridesToString(object obj)
        {
            if (obj == null)
                throw new ArgumentNullException(nameof(obj));
            
            Delegate func = obj.ToString;
            return func.Method.DeclaringType != typeof(object);
        }
        /// <summary>
        /// Gets whether the specified object overrides <see cref="object.GetHashCode"/>.
        /// </summary>
        public static bool OverridesGetHashCode(object obj)
        {
            if (obj == null)
                throw new ArgumentNullException(nameof(obj));

            Delegate func = obj.GetHashCode;
            return func.Method.DeclaringType != typeof(object);
        }
    }
}
