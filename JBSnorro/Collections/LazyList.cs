...
public sealed class LazyList<T> : IList<T>, ILazilyCachable<T>, IDisposable
{
	...
	public LazyList(IEnumerable<T> enumerable, int initialCapacity = DEFAULT_CAPACITY)
	{
	...
	public LazyList(Func<int, T> generator, int initialCapacity = DEFAULT_CAPACITY)
