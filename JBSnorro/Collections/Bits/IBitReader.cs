...
public interface IBitReader
{
    ...
    /// <summary>
    /// Gets an in-lock-step <see cref="IBitReader"/>  starting at the current position for the specified number of bits.
    /// </summary>
    public virtual IBitReader CreateSubReader(ulong bitCount)
    {
        return new SubBitReader(this, bitCount);
    }
