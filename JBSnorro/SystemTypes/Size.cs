...
namespace JBSnorro.SystemTypes
{
	...
	{
		internal const string WidthAndHeightCannotBeNegative = "Width and height cannot be negative";
		internal const string CannotModifyEmptySize = "Cannot modify empty size";
		internal const string WidthCannotBeNegative = "Width cannot be negative";
		internal const string HeightCannotBeNegative = "Height cannot be negative";
		#region Constructors
		...
		public double Width
		{
			...
			set
			{
				if (IsEmpty)
				{
					throw new System.InvalidOperationException(Size.CannotModifyEmptySize);
				}
