...
// BECAUSE I NEED THESE TYPES BUT THEY AREN'T AVAILABLE IN .NET CORE
...
namespace JBSnorro.SystemTypes
{
	...
	{
		internal const string CannotModifyEmptyRect = "Cannot modify empty rectangle";
		internal const string CannotCallMethod = "Cannot call method on empty ?rectangle?";
		#region Constructors
					...
					double height)
		{
			if (width < 0 || height < 0)
			{
				throw new System.ArgumentException(CannotModifyEmptyRect);
			}
		...
		public Point Location
		{
			...
			set
			{
				if (IsEmpty)
				{
					throw new System.InvalidOperationException(CannotModifyEmptyRect);
				}
		...
		public double Width
		{
			...
			set
			{
				if (IsEmpty)
				{
					throw new System.InvalidOperationException(Rect.CannotModifyEmptyRect);
				}

				if (value < 0)
				{
					throw new System.ArgumentException(Size.WidthCannotBeNegative);
				}
		...
		public double Height
		{
			...
			set
			{
				...
				if (value < 0)
				{
					throw new System.ArgumentException(Size.HeightCannotBeNegative);
				}
		...
		public void Offset(double offsetX, double offsetY)
		{
			if (IsEmpty)
			{
				throw new System.InvalidOperationException(Rect.CannotCallMethod);
			}
