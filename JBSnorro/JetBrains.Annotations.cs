...
{
	/// <summary> Denotes that the method decorated with this attribute is a assertion method, and therefore works in conjuction with
	/// NotNullAttribute, where otherwise a warning would be generated. This attribute is not standard, but not obsolete either. </summary>
	[AttributeUsage(AttributeTargets.All, AllowMultiple = true, Inherited = true)]
	public sealed class AssertionMethodAttribute : Attribute
	{
		public AssertionMethodAttribute() { }
		public AssertionMethodAttribute([UsedImplicitly] string parameterName) { }
	}
	...
	public sealed class PublicAPIAttribute : Attribute
	{
		...
		public PublicAPIAttribute([UsedImplicitly] string comment) { }
	}
